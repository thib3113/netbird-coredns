Last check : <!-- START last_run_sync -->`2026-04-23T00:15:33.539Z`<!-- END last_run_sync -->

CoreDNS version : <!-- START latest_release_version -->`1.14.3`<!-- END latest_release_version -->

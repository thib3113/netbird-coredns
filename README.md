Last check : <!-- START last_run_sync -->`2026-01-09T00:04:06.555Z`<!-- END last_run_sync -->

CoreDNS version : <!-- START latest_release_version -->`1.14.0`<!-- END latest_release_version -->
